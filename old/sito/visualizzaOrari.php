...
<div class="container-lg p-responsive pb-6" style="padding-bottom: 0px!important;">
    ...
    <p class="lead-mktg text-gray text-center col-md-8 mx-auto mb-4">
      Qui puoi modificare le tue fascie orarie in base alle tue esigenze 
    </p>
  </div>
...
<?php 
	...
	if($row['giorno']==$oldGiorno){
		...
		?>	
	<h2><?php echo strtoupper($row['giorno']."<br>")?></h2>
	<?php
	}
	?>
		...
		<td>
			<?php
				echo("<a href='editOrario.php?idOrario=".$row['ID']."'><input style='width:100%' type='button' name='edit' value='Modifica'></a>");
			?>
		</td>
		<td>
			<?php
				echo("<a href='deleteOrario.php?idOrario=".$row['ID']."'><input style='width:100%' type='button' name='delete' value='X'></a>");
			?>
		</td>
...
<?php 
	...
	<br>
	<br>
<a href='addOrario.php?'><input style='width:100%' type='button' name='add' value='Aggiungi una fascia oraria'></a>
