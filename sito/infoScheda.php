...
$sql = "SELECT * FROM scheda join posizione on scheda.cod=posizione.idScheda where idEnte='$codEnte' AND scheda.cod='$idScheda' AND posizione.dataOra>='$dataInizio' AND posizione.dataOra<='$dataFine' ORDER BY posizione.dataOra ASC";
