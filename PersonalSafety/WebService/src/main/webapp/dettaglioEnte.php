...
while($row = $result->fetch_assoc()){
	...
	$tabellaUtilizzoScheda.="<tr class='$classMia'><td>$idScheda</td><td>$dInizio</td><td>$dFine</td><td><input style='width:100%; height:100%;' type='button' value='Info' onClick=\"info('$idScheda','$dInizio','$dFine')\" ></td></tr>";
	$i++;
}
...
<div class="container-lg p-responsive pb-6" style="padding-bottom: 0px!important;">
    ...
    <p class="lead-mktg text-gray text-center col-md-8 mx-auto mb-4">
      Elenco delle schede Personal Safety che hai utilizzato presso questo ente: 
    </p>
	<img src="<?php echo($_GET["img"]); ?>" alt="Smiley face" height="300px" class="imgGrande">
</div>

<p class="lead-mktg text-gray text-center col-md-8 mx-auto mb-4">
	<input type="button" value="Visualizza le tue prenotazioni" onClick="window.location='listaPrenotazioni.php?codEnte=<?php echo $idEnte; ?>';"><br><br>
	<input type="button" value="Effettua una prenotazione" onClick="window.location='prenota.php?codEnte=<?php echo $idEnte; ?>';">
</p>
