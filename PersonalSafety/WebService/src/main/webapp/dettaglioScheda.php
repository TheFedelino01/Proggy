    ...
    <script>
        ...
        function associa() {
            ...
            $.ajax({
                ...
                //console.error(errorThrown);
                $("#errors").html("Associazione non riuscita.<br>" + errorThrown + "<br>Assicurati che il Web Service sia attivo e funzionante");
            });
            return false;
        }
    </script>
        ...
        <div class="container-xl d-lg-flex flex-items-center p-responsive">
            <div class="d-flex flex-justify-between flex-items-center">
                ...
                <div class="d-flex flex-items-center">
                    <b><a style="color:yellow!important;" href="admin.php"
                          class="d-inline-block d-lg-none f5 text-white no-underline border-gray-dark rounded-2 px-2 py-1 mr-3 mr-sm-5">
                            Home
                        </a></b>
                    <a href="login.php"
                ...
                <nav class="mt-0 px-3 px-lg-0 mb-5 mb-lg-0" aria-label="Global">
                    <ul class="d-lg-flex list-style-none">
                                ...
                                <div class="dropdown-menu flex-auto rounded-1 bg-white px-0 mt-0 pb-4 p-lg-4 position-relative position-lg-absolute left-0 left-lg-n4">
                                    ...
                                    <ul class="list-style-none f5 pb-3">
                                        <li class="edge-item-fix"><a href="index.php"
                                                                     class="py-2 lh-condensed-ultra d-block link-gray no-underline f5">Welcome
                                                Page</a></li>
                        ...
                        <li class="border-bottom border-lg-bottom-0 mr-0 mr-lg-3">
                            <b><a style="color:yellow;" href="admin.php"
                                  class="HeaderMenu-link no-underline py-3 d-block d-lg-inline-block"
                                  data-ga-click="(Logged out) Header, go to Team">Home</a></b>
                        </li>
                    </ul>
                </nav>
                    ...
                    <table>
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            <tr class='<?php echo $classMia; ?>'>
                                ...
                                <td><input style='width:100%; height:100%;' type='button' value='Info'
                                           onClick="info('<?php echo $_GET['idScheda']; ?>','<?php echo $dInizio; ?>','<?php echo $dFine; ?>')">
                                </td>
                            </tr>
                            <?php
                            $i++;
                    ...
                    <div>
                        <form onsubmit="return associa()">
                            <dl class="form-group my-3 required">
                                ...
                                <dd>
                                    <input class="form-control input py-1" type="number" name="idUtente" id="idUtente"
                                           required>
                                </dd>
                            </dl>
