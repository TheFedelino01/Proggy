...
<head>
    ...
    <script>
        ...
        function registra() {
            ...
            xml = "<scheda><idScheda>" + idScheda + "</idScheda><idEnte><?php echo $ente['cod']; ?></idEnte></scheda>";
            ...
            $.ajax({
                ...
                if (jqXHR.status === 409)
                    ...
                    $("#errors").html("Registrazione non riuscita.<br>" + errorThrown + "<br>Assicurati che il Web Service sia attivo e funzionante");
            });
            return false;
        }
    </script>
                ...
                <div id="tabellaSchede" style="padding-top: 20px; ">
                    <table>
                        ...
                        foreach ($schede as $s) {
                            ...
                            <tr>
                                <td><?php echo $s; ?></td>
                                <td><a href="dettaglioScheda.php?idScheda=<?php echo $s; ?>">
                    ...
                    <div>
                        <form onsubmit="return registra()">
                            <dl class="form-group my-3 required">
                                ...
                                <dd>
                                    <input class="form-control input py-1" type="number" name="idScheda" id="idScheda"
                                           required>
                                </dd>
                            </dl>
