...
public enum ACCESSPOINTS {
    ...
    POINT_CAMERA("Saccani ROG MODEM", "fcecda384364", new coordinate(45.70408, 9.19004),0),
    POINT_SOTTO("Saccani ROG MODEM - 2.4G", "b8d5261593d", new coordinate(45.70408, 9.18996),0),
    POINT_SOGGIORNO("Saccani ROG MODEM", "18e82951f2cf", new coordinate(45.70399, 9.1899),0);
