...
//                            .collect(Collectors.toList());
                    ...
                    for (int i = 1; i < reti.length; i++) {
                        ...
                        for (ACCESSPOINTS ap : ACCESSPOINTS.values())
                            if (rete[0].equals(ap.getMac())) {
                                ap.setPotenza(Double.parseDouble(rete[1]));
                                apList.add(ap.toAPInfo());
                            }
                    }
                    ...
                    manager.salvaCoordinate(reti[0], Trilateration.getPoint(apList.get(0), apList.get(1), apList.get(2)));
